...
CREATE TABLE orders (
    ...
    order_channel_id BIGINT NOT NULL,
    ...
    total_shipping_cost NUMERIC(12, 2) NOT NULL,
...
create table geo_location (
    ward_code BIGINT NOT NULL PRIMARY KEY,
...
CREATE TABLE warehouse (
    ...
    geo_location_id BIGINT NOT NULL REFERENCES geo_location(ward_code),
...
CREATE TABLE inventory (
    ...
    safety_stock INT NOT NULL DEFAULT 0, -- lượng tồn kho an toàn tối thiểu
    reorder_level INT NOT NULL DEFAULT 0, -- mức cần đặt lại hàng
    last_counted_at TIMESTAMP,
    unit_cost NUMERIC(12, 2) NOT NULL, -- giá vốn đơn vị
    is_active BOOLEAN NOT NULL DEFAULT TRUE,
    created_at TIMESTAMP NOT NULL DEFAULT now(),
    updated_at TIMESTAMP NOT NULL DEFAULT now(),
