...
**Phương thức lấy dữ liệu:**
- Sử dụng kết nối trực tiếp đến cơ sở dữ liệu PostgreSQL của hệ thống nội bộ (website, ERP, CRM) thông qua thư viện SQLAlchemy.

**Định dạng dữ liệu:**
- Dữ liệu được truy vấn trực tiếp từ các bảng trong cơ sở dữ liệu như order_channel, product, geo_location, payment, và sub_category.

**Các loại dữ liệu chính:**
- Dữ liệu danh mục sản phẩm, thông tin kênh bán hàng, vị trí địa lý, chi tiết sản phẩm, và phương thức thanh toán được lưu trữ trong hệ thống ERP.

**Xử lý và lưu trữ dữ liệu:**
- Dữ liệu sau khi được trích xuất từ PostgreSQL được chuyển đổi sang định dạng Parquet và lưu trữ trong MinIO theo cấu trúc thư mục phân cấp dựa trên loại dữ liệu và thời gian. Quá trình này được tự động hóa thông qua các DAG Airflow như extract_order_channel, extract_product, extract_payment, v.v.
...
- Tổng doanh thu, doanh thu theo ngày/tháng/năm
...
**Các dashboard:**
1. **Sales Performance Dashboard**: Tổng quan về doanh số, xu hướng doanh thu, lợi nhuận.
2. **Inventory & Logistics Dashboard**: Theo dõi tồn kho và trạng thái đơn hàng vận chuyển.
