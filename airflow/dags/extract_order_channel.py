...
def save_order_channel(**context):
    ...
    try:
        ...
        # Tạo object name
        object_name = f"cleaned/erp/order_channel/year={logical_date.year}/month={logical_date.month:02d}/day={logical_date.day:02d}/{logical_date.strftime('%Y-%m-%d')}_data.parquet"
