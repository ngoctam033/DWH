...
def save_geo_location(**context):
    ...
    try:
        ...
        # Tạo object name
        object_name = f"layer=cleaned/year={logical_date.year}/month={logical_date.month:02d}/day={logical_date.day:02d}/channel=erp/data_model=geo_location/{logical_date.strftime('%Y-%m-%d')}_data.parquet"
